        ...
        <div className="space-y-6">
          ...
          children slot — overlay siblings instead of passing via children. */}
            <header className="relative rounded-xl overflow-hidden border border-ink-200 dark:border-ink-800">
                ...
                />
                <div
                    className="absolute inset-0 z-20 flex flex-col justify-end sm:flex-row sm:items-end sm:justify-between gap-3 p-6 pointer-events-none">
                    ...
                    >
                        ...
                        {status.state === "thinking" && (
                            <div className="flex justify-start">
                                <div
                                    className="max-w-[85%] px-3 py-2 rounded-lg bg-ink-100 dark:bg-ink-800 text-ink-700 dark:text-ink-200 text-sm whitespace-pre-wrap">
                                    {streamingText ? (
            ...
            {summary && (
                <section
                    className="rounded-lg border border-ink-200 dark:border-ink-800 bg-ink-50 dark:bg-ink-800/60 p-5 space-y-3 print-a4">
